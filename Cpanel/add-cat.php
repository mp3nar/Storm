      ...
      <div class="add-page-fields-container">
          <div class="information-container">
           <div class="info cat-thing">
                  ...
                  <form action='add_cat_proccess.php' method='post' id="add_cat">
          <div class="fields-cat">
   
           <input type="text" class='cat-name' name='cat_name' placeholder="اسم التصنيف" />
       <input type="text" class='cat-desc' name="cat_desc" placeholder="وصف التصنيف" />
 
          </div>
        
     
      </form>
      <button class='add_cat_proccess'>حفظ</button>
      </div>
...
$(".dropdown-down").click(function () {
 ...
 $('.add_cat_proccess').click(function () {
   ...
   if ($('.cat-name').val().length == 0 || $('.cat-desc').val().length == 0 ) {
