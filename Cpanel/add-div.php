      ...
      <div class="add-page-fields-container">
          <div class="information-container">
           <div class="info cat-thing">
                  ...
                  <form action='add_div_proccess.php' method='post' id="add_cat">
          <div class="fields-cat">
           <input type="text" class='div-name' name='div_name' placeholder="اسم القسم" />
       <input type="text" class='div-desc' name="div_desc" placeholder="وصف القسم" />
...
$(".dropdown-down").click(function () {
 ...
 $('.add_cat_proccess').click(function () {
      ...
      if ( $('.div-name').val().length == 0 || $('.div-desc').val().length == 0) {
