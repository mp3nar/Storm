...
<div class="articles-section-container">
 ...
 <table style="width:100%; direction:rtl;">
     ...
     <th style="width:20%;font-size:10pt;">وصف الحالة الامنية</th>
     <th style="width:20%;font-size:10pt;">التاريخ</th>
     <th style="border-left:none; width:20%;font-size:10pt;">المستخدم</th>     
...
$shows_number = mysql_num_rows(mysql_query("select * from security_log order by id desc"));
$d_c = $shows_number/$y;
     $get_messages = mysql_query("select * from security_log limit $x,$y");
  ...
  $hide_pagination = "block";
     ...
     while($extract_messages = mysql_fetch_assoc($get_messages)) {
      ...
      echo '
       <tr>
      <th style="font-size:10pt;">'.$extract_messages['id'].'</th>
     <th style="width:20%;font-size:10pt;">'.$extract_messages['security_statue'].'</th>
     <th style="width:10%;font-size:10pt;">'.$extract_messages['security_date'].'</th>
      <th style="border-left:none; width:20%;font-size:10pt;">'.$extract_messages['security_user'].'</th>
       </tr>
...
<script>
 $(".page").click(function () {
      ...
      $(".articles-section-container").load("all-security-pagination.php?page=" + pagenumber);
   ...
   $(".next-page").click(function () {
      ...
      $(".articles-section-container").load("all-security-pagination.php?page=" + page);
      $("html,body").animate({scrollTop:'25'});
   ...
   $(".next").click(function () {
      ...
      $(".articles-section-container").load("all-security-pagination.php?page=" + page_cc );
        $("html,body").animate({scrollTop:'25'});
   });
</script>
<script type="text/javascript">
