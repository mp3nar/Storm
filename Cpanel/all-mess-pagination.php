...
$d_c = $shows_number/$y;
  ...
  $hide_pagination = "block";
     ...
     while($extract_messages = mysql_fetch_assoc($get_messages)) {
      ...
      echo '
       <tr>
      <th style="font-size:10pt;">'.$extract_messages['sender_name'].'</th>
     <th style="width:20%;font-size:10pt;">'.$extract_messages['sender_email'].'</th>
     <th style="width:10%;font-size:10pt;">'.$extract_messages['message_date'].'</th>
