...
<div class="all-articles-container">
 <div class="add-article-sign"><h3>جميع التصنيفات</h3></div>   
...
$shows_number = mysql_num_rows(mysql_query("select * from caterogies_table order by id desc"));
$d_c = $shows_number/$y;
          $extract_cat = mysql_query("select * from caterogies_table order by id desc limit $x,$y");
  if(mysql_num_rows($extract_cat) < 1) {
  $hide_pagination = "none";
 }else {
  $hide_pagination = "block";
 }
           while ($cat = mysql_fetch_assoc($extract_cat)) {
            echo '
      <tr style="font-size:12pt;">
     <th style="font-size:12pt;">'.$cat['id'].'</th>
     <th style="width:30%;text-align:right;font-size:12pt;"><a href="" style="color:white;">'.$cat['cat_name'].'</a></th>
     <th style="font-size:12pt;width:30%;">'.$cat['cat_desc'].'</th>
    
     <th class="properties" style="border-left:none; width:30%;font-size:12pt;padding-right:5px;padding-left:0px;padding-top:20px">
        <div class="edit-article caterojy-edit"><a href="deletecat.php?id='.$cat['id'].'"> <h3>حذف</h3></a></div> 
        </th>     
...
$(".dropdown-down").click(function () {
 ...
 $(".page").click(function () {
      ...
      $(".articles-section-container").load("all-cat-pagination.php?page=" + pagenumber);
   ...
   $(".next-page").click(function () {
      ...
      $(".articles-section-container").load("all-cat-pagination.php?page=" + page);
      $("html,body").animate({scrollTop:'25'});
   ...
   $(".next").click(function () {
      ...
      $(".articles-section-container").load("all-cat-pagination.php?page=" + page_cc );
        $("html,body").animate({scrollTop:'25'});
   });
});    
</script>    
