...
//////////////////////////////////////////////////////////////////
$login = intval($_GET['id']);
$extract_user_data = mysql_query("select * from users_table where id='$login'");
...
<div class="add-article-container">
    ...
    <div class="add-article-sign"><h3>تعديل حساب</h3></div>
    <div class="information-container">
  <form action="edit_member_proccess.php" method="post" enctype="multipart/form-data" id="form">      
       <div class="info">
        <h3>:الاسم</h3>
        ...
        <div class="info">
        <h3>:اسم المستخدم</h3>
            <input id='name' type='text' value="<?php echo $user_data['user_name']; ?>" name="user_name"  />
    </div>    
    <div class="info">
        ...
        <div class="info">
        <h3>:كلمة السر </h3>
           <input type='text' value="<?php echo $user_data['user_password']; ?>" name="user_password"  />
        </div>
     <div class="info">
